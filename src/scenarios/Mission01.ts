...
const chatList: Array<Chat> = [
  ...
  {speaker: 'human', comment: '今回はこの星一番の人気物件@「haitsu_yamada」が建物名@ですね。...カラム名ってなんでしたっけ？'  },
  {speaker: 'dog', comment: '@カラム名は今矢印で示している部分@のことだよ。「ハイツ山田」に入居している人の情報の種類を示しているんだね。今回は@「部屋番号, 名前, 引越し日」@のことだよ。'},
